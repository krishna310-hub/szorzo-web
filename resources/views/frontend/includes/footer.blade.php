<!-- Footer Start -->
                        ...
                        <div class="footer-links">
                            ...
                            <ul>
                                <ul class="contact-info">
                                    <li><a href="tel:+919901419393"><i class="fa-solid fa-phone"></i> +91 990 141
                                            9393</a></li>
                                    <li><a href="mailto:business@szorzo.com"><i class="fa-solid fa-envelope"></i>
                                            business@szorzo.com</a></li>
    ...
    <!-- flowmap js file -->
    <script src="{{ asset('frontend/js/flowmap-effect.min.js')}}"></script>
    <!-- Main Custom js file -->
