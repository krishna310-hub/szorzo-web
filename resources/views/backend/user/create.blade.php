                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="user-form" action="{{ route('admin.user.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-md-4">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="user_name" name="user_name"value="{{ old('user_name') }}" placeholder="Enter Role Name">
