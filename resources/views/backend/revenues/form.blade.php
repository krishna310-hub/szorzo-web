...
<div class="row">
    ...
    <div class="col-md-6 mb-3"><label class="form-label">Invoice Number <span class="text-danger">*</span></label><input name="invoice_number" class="form-control" required value="{{ old('invoice_number', $revenue->invoice_number ?? '') }}" placeholder="SZ 16 2026-2027"></div>
    ...
    <div class="col-md-4 mb-3"><label class="form-label">Revenue</label><input id="service_preview" class="form-control" disabled></div>
...
function calculateRevenue() {
    ...
    const revenue = ctc * billing / 100, gst = revenue * gstRate / 100;
    $('#service_preview').val('₹' + revenue.toFixed(2));
...
$(function () {
    ...
    $('.calc').on('input', calculateRevenue);
    calculateRevenue();
});
</script>
@endpush
