...
<div class="main-content"><div class="page-content"><div class="container-fluid"><div class="row"><div class="col-lg-12"><div class="card">
    <div class="card-header d-flex align-items-center">
        <h5 class="card-title mb-0 flex-grow-1">Services Offered</h5>
        <div class="d-flex flex-wrap gap-2">
            <a href="{{ route('admin.services-offered.export') }}" class="btn btn-sm btn-info">Export</a>
            <button class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#importModal">Import</button>
            <a href="{{ route('admin.services-offered.create') }}" class="btn btn-sm btn-primary">Add New</a>
        </div>
    </div>
    <div class="card-body">
        ...
        <table id="datatable" class="table table-bordered nowrap w-100"><thead><tr>
            <th>S.No</th><th>Service Name</th><th>Service Code</th><th>Category</th><th>Status</th><th>Action</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Import Services Offered</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('admin.services-offered.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <a href="{{ route('admin.services-offered.import-template') }}">Download Template</a>
                </div>
...
$(document).ready(function () {
    var table = $('#datatable').DataTable({
        ...
        ajax: { url: '{{ route('admin.services-offered.index') }}', type: 'GET' },
        columns: [
