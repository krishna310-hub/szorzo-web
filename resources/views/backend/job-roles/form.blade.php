<div class="row gy-4">
    <div class="col-md-4">
        ...
        <input type="text" class="form-control" id="job_role" name="job_role" value="{{ old('job_role', $jobRole->job_role ?? '') }}" placeholder="Enter job role">
        @error('job_role')<span class="text-danger small">{{ $message }}</span>@enderror
    </div>
    <div class="col-md-4">
