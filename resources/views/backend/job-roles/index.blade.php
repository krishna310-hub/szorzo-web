                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            ...
                            @can('create', \App\Models\JobRole::class)
                                <a href="{{ route('admin.job-roles.create') }}" class="btn btn-sm btn-primary">Add New Job Role</a>
                            @endcan
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="job-roles-table" class="table table-bordered dt-responsive nowrap w-100">
                                    <thead>
                                        <tr>
                                            <th>S.No</th>
                                            <th>Job Role</th>
...
<script>
    $(document).ready(function () {
        var table = $('#job-roles-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: { url: '{{ route('admin.job-roles.index') }}', type: 'GET' },
            columns: [
