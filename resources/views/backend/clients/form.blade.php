<div class="row gy-4">
    <div class="col-md-4">
        <label for="name" class="form-label">Client <span class="text-danger">*</span></label>
        <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $client->name ?? '') }}" placeholder="Enter client name">
