...
class EmployeePolicy {
    ...
    private function allowed(User $user, string $name): bool { $id = Permission::where('page', 'employee')->where('name', $name)->value('id'); return (bool) ($id && $user->role?->permissions->contains('id', $id)); }
}
