...
class CandidateController extends Controller
{
    ...
    public function import(Request $request)
    {
        ...
        foreach ($rows as $index => $row) {
            ...
            $validator = Validator::make($data, [
                ...
                'contract_to_date' => 'nullable|date|after_or_equal:contract_from_date',
    ...
    private function validatedData(Request $request, ?Candidate $candidate = null): array
    {
        ...
        $data = $request->validate([
            ...
            'hourly_salary' => 'nullable|numeric|min:0.01',
            'candidate_name' => 'required|string|max:255',
            'mobile_no' => [
                'required',
                'string',
            ...
            'upload_cv' => [$candidate ? 'nullable' : 'required', 'file', 'mimes:pdf,doc,docx', 'max:2048'],
            'status' => 'required|in:0,1',
        ], [
